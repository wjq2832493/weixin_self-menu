...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/wjq_self_menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/wjq_self_menu/js/jquery.js"></script>
<script type="text/javascript" src="/wjq_self_menu/js/vue.js"></script>
<script type="text/javascript" src="/wjq_self_menu/js/menu.js"></script>
